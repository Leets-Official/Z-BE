...
public interface MemberRepository extends JpaRepository<Member, Long> {
  ...
  boolean existsByKakaoNicknameAndKakaoId(String kakaoNickname, Long kakaoId);
  Optional<Member> findByKakaoNicknameAndKakaoId(String kakaoNickname, Long kakaoId);
}
